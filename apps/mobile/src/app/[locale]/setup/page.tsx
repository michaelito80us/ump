      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-lg shadow-md p-8 text-center max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            {t('tournamentCreated', {
              default: 'Tournament created successfully!',
            })}
          </h2>
          <p className="text-gray-600 mb-6">
            {t('tournamentPublished', {
              default:
                'Your tournament has been published and is ready for team registration.',
            })}
          </p>
          <Link
            href="/"
          ...
          {currentStep === 3 && (
            <div>
              ...
              <p className="text-gray-600">
                {t('formatDescription', {
                  default:
                    'Round-robin format with knockout finals will be used.',
                })}
              </p>
            </div>
          )}
            ...
            <div>
              ...
              <p className="text-gray-600">
                {t('pluginsDescription', {
                  default:
                    'Default rugby scoring and scheduling plugins will be used.',
                })}
              </p>
            </div>
          )}
            ...
            {currentStep < 5 ? (
              ...
              >
                {isPublishing
                  ...
                  : t('publish', { default: 'Publish Tournament' })}
              </button>
            )}
          </div>
        </div>
